...
$thispageurl = new moodle_url('/local/augmented_teacher/reminders_log.php', array(
    'page' => $page,
    'perpage' => $perpage,
    'sort' => $sort,
    'dir' => $dir,
...
// Action icons.
$iconlog = $OUTPUT->pix_url('t/log');
$iconedit = $OUTPUT->pix_url('t/edit');
$icondelete = $OUTPUT->pix_url('t/delete');
...
$pagingurl = new moodle_url('/local/augmented_teacher/reminders_log.php',
    array(
        'perpage' => $perpage,
        'sort' => $sort,
        'dir' => $dir,
