...
/**
 * Event triggered after a reminder is updated.
 *
 * @package    local_augmented_teacher
 * @since      Moodle 3.2+
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class reminder_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreminderupdated', 'local_augmented_teacher');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has updated the reminder with id '$this->objectid'.";
    }
