...
/**
 * Event triggered after a reminder is created.
 *
 * @package    local_augmented_teacher
 * @since      Moodle 3.2+
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class reminder_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventremindercreated', 'local_augmented_teacher');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has created the reminder with id '$this->objectid'.";
    }
